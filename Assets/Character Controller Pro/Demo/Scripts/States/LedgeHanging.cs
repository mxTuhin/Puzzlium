...
{    
    ...
    {
        GameManager.instance.inState = GameManager.InState.inLedge;
    ...
    {
        HitInfoFilter ledgeHitInfoFilter = new HitInfoFilter( layerMask , true , true );
        return !CharacterActor.CharacterCollisions.CheckOverlapWithLayerMask( 
